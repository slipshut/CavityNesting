...
eigengenes_all_ind <- read.csv(
   "C:/Users/18126/OneDrive - University of Toronto/Projects/bird_expression/wgcna/eigengenes_male.csv")
...
write.csv(model_results_df, "wgcna_pglm_male_results.csv")
